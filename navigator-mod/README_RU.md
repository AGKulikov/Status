...
Ещё не реализованы в этом каталоге: извлечение полного navigation snapshot из 30.3.0,
синхронизация камеры/маршрута второго MapWindow с активной сессией и применение тех параметров
стиля, для которых нужен внутренний слой Навигатора. Старое покадровое копирование не используется.
