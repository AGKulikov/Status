...
Ещё не реализованы в этом каталоге: извлечение полного navigation snapshot из 30.3.0, отдельный
`OffscreenMapWindow` и выдача настоящего HUD Surface. Эти capabilities намеренно не объявляются,
чтобы незавершённый код не включил старое покадровое копирование.
