...
REQUIRED = {
    ...
    P+'map/MapObjectCollection;': {('addEmptyPlacemark','('+P+'geometry/Point;)'+P+'map/PlacemarkMapObject;')},
    P+'map/BaseMapObjectCollection;': {('clear','()V'), ('remove','('+P+'map/MapObject;)V')},
    ...
    P+'map/PlacemarkMapObject;': {('setGeometry','('+P+'geometry/Point;)V'),
        ('setIcon','(Lcom/yandex/runtime/image/ImageProvider;'+P+'map/IconStyle;'+P+'map/Callback;)V'),
        ('setIconStyle','('+P+'map/IconStyle;)V'),
        ('setIcon','(Lcom/yandex/runtime/image/ImageProvider;'+P+'map/IconStyle;)V'),
        ('setScaleFunction','(Ljava/util/List;)V')},
    P+'map/Callback;': {('onTaskFinished','()V')},
    'Lcom/yandex/runtime/i18n/I18nManager;': {('localizeDistance','(I)Ljava/lang/String;')},
    'Lcom/yandex/runtime/i18n/I18nManagerFactory;': {('getI18nManagerInstance','()Lcom/yandex/runtime/i18n/I18nManager;')},
