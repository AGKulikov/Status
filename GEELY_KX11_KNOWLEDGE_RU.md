...
отсутствие свечения не объявляется исправленным. Физический результат новой
версии пока не получен. Все последующие старые выводы о first-frame gate — история.
