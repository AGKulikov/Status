...
этапов может оставить карту скрытой. Установленная на машине версия мода Navigator
из пары 2.8.8 пока не подтверждена; одинаковый versionName 30.3.0 её не устанавливает.
Точная причина отказа не доказана без уточнения состава пары и диагностики этого запуска.
