...
Версия 1.5 • дополнение 10 сентября 2026 года • автомобиль и прошивка из переданных пользователем материалов. Исходные разделы и публичный ZIP 1.0 сохраняют результаты 4 сентября, редакция 1.2 — расширенный разбор 5 сентября.
Аппаратные замечания после Natro 2.8.4 и соответствующие исходные изменения актуализированы ниже; это не означает аппаратную приёмку до отдельного измерения на KX11.
...
В исходнике для 2.8.5 эти операции привязаны к изменению содержимого: авторазмер и footprints
