...
однородного непрозрачного белого bootstrap-буфера. Следующая исходная реализация принимает
...
Автотест 20 000 snapshot и длительная проверка процесса на KX11 закреплены в `GATE-081`.
