#!/usr/bin/env python3
"""Portable source/asset audit for Helper 60 compact Live Activity and companion UI."""
...
assert 'replaceActivities(reason: "обновление Helper 60")' in manager
...
print("PASS: Helper v60 compact payload, car asset, demo controls, journals and startup repair")
