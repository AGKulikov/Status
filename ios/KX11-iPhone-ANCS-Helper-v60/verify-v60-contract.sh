...
python3 "$ROOT/verify_live_activity_v60.py"

PROJECT="$ROOT/KX11ANCSHelper.xcodeproj/project.pbxproj"
[ "$(grep -Fc 'CURRENT_PROJECT_VERSION = 60;' "$PROJECT")" -eq 4 ]
[ "$(grep -Fc 'MARKETING_VERSION = 60.0;' "$PROJECT")" -eq 4 ]
...
echo 'PASS: Helper v60 enlarges Live Activity labels and coalesces ActivityKit updates'
