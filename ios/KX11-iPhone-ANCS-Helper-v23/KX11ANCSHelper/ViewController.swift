...
/// Helper v23 uses Central only to bootstrap the protected ANCS link. At the same time it exposes
...
final class ViewController: UIViewController {
    ...
    private let restoreIdentifier =
        "ru.natro.kx11ancshelper.peripheral.v23.single-link-g3"
    private let centralRestoreIdentifier =
        "ru.natro.kx11ancshelper.central.v23.geely-ancs-g2"
    ...
    override func viewDidLoad() {
        ...
        append("v23: выбран iPhone \(role.title); Peripheral сохраняет маршрут v11")
        ...
        append("B2/B3 discovery: один отложенный unfiltered запрос без пересечений")
    ...
    private func buildInterface() {
        ...
        titleLabel.text = "KX11 ANCS HELPER v23"
    ...
    private func connectCentral(_ peripheral: CBPeripheral, reason: String) {
        ...
        // deterministic: Helper v23 always resolves the next generation from a fresh advert.
    ...
    private func beginCentralDiscovery(_ peripheral: CBPeripheral) {
        ...
        // Enumerate the current database without a UUID filter. On this KX11 Core Bluetooth can
        // reject a filtered discovery with uuidNotAllowed even though the ATT link is healthy.
    ...
    private func scheduleCentralServiceRediscovery(_ peripheral: CBPeripheral,
        ...
        let item = DispatchWorkItem { [weak self, weak peripheral] in
            ...
            self.append("D2D9 full service rediscovery · attempt \(attempt) · \(reason)")
            peripheral.discoverServices(nil)
        }
...
extension ViewController: CBCentralManagerDelegate {
    ...
    private func handleCentralDisconnect(_ peripheral: CBPeripheral, isReconnecting: Bool,
        ...
        if isReconnecting {
            // Handles a restored connection originally created by an older Helper. New v23
