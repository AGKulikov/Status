...
/// Helper v15 exposes two mutually exclusive BLE routes. Peripheral is the v11 production route
...
final class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        append("v15: выбран iPhone \(role.title); Peripheral сохраняет маршрут v11")
    ...
    private func buildInterface() {
        ...
        titleLabel.text = "KX11 ANCS HELPER v15"
    ...
    private func responseData(for characteristic: CBCharacteristic) -> Data? {
        ...
        case infoUUID:
            return Data("\(logicalName)/15/realtime-single-link".utf8)
        case secureUUID:
