#!/usr/bin/env python3
"""Portable source/asset audit for Helper 59 compact Live Activity and companion UI."""
...
assert 'replaceActivities(reason: "обновление Helper 59")' in manager
assert "minimumActivityUpdateInterval: TimeInterval = 0.75" in manager
...
assert "minimumScaleFactor(0.68)" in widget
...
print("PASS: Helper v59 compact payload, car asset, demo controls, journals and startup repair")
