...
[ "$(grep -Fc 'CURRENT_PROJECT_VERSION = 54;' "$PROJECT")" -eq 2 ]
[ "$(grep -Fc 'MARKETING_VERSION = 54.0;' "$PROJECT")" -eq 2 ]
...
echo 'PASS: Helper v54 preserves enrollment/ANCS and adds exact-owner Bluetooth car control'
