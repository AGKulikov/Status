...
struct NatroLiveActivityAttributes: ActivityAttributes {
    ...
    struct ContentState: Codable, Hashable {
        ...
        /// Decode-only bridge for a card left running by Helper 56. Never encoded by Helper 65.
...
enum NatroLiveActivityCommandMailbox {
    ...
    static var supportsSharedDelivery: Bool { sharedContainerURL() != nil }
    ...
    private static func defaults() -> UserDefaults {
        guard sharedContainerURL() != nil else { return .standard }
