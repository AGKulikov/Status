#!/usr/bin/env python3
"""Portable source/asset audit for Helper 58 compact Live Activity and companion UI."""
...
assert 'replaceActivities(reason: "обновление Helper 58")' in manager
...
print("PASS: Helper v58 compact payload, car asset, demo controls, journals and startup repair")
