...
final class HelperSettingsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        configureView()
        ANCSConnectionJournal.shared.append("app", "Helper 58 запущен")
        carRemoteClient.onDiagnostic = { message in
            ANCSConnectionJournal.shared.append("C5", message)
        }
        ...
        do {
            ...
            runtime.onDiagnosticEvent = { message in
                ANCSConnectionJournal.shared.append("BLE", message)
            }
