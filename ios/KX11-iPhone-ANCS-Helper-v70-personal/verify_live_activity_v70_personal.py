#!/usr/bin/env python3
"""Portable audit for Helper 70 Personal Team local ActivityKit lifecycle and controls."""
...
assert 'replaceActivities(reason: "обновление Helper 70")' in manager
...
print("PASS: Helper v70 Personal Team entitlement-clean Live Activity controls and compact payload")
