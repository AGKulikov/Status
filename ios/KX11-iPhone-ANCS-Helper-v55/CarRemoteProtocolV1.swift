...
public final class CarRemoteClient {
    /// Read-only state ids carried beside the fixed 39-control catalog. They are never accepted
    ...
    private let expectedCatalogIDs = Set(CarRemoteCatalogV1.controls.map(\.id))
