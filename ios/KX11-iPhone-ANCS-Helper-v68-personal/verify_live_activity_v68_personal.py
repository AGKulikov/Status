#!/usr/bin/env python3
"""Portable audit for Helper 68 Personal Team local ActivityKit lifecycle and controls."""
...
assert 'replaceActivities(reason: "обновление Helper 68")' in manager
...
print("PASS: Helper v68 Personal Team entitlement-clean Live Activity controls and compact payload")
