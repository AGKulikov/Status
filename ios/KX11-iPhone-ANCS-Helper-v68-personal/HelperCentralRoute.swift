    ...
    public final class Coordinator: NSObject {
        ...
        internal init(
            ...
            self.queue = DispatchQueue(
                label: "ru.natro.kx11ancshelper.v54.routeB.central",
                qos: .userInitiated
            )
        ...
        private func startOnQueue(
            ...
            diagnostic("создан Central-владелец; ожидаем состояние Bluetooth и восстановление")
        ...
        private func beginAcquisition(on manager: CBCentralManager) {
            ...
            diagnostic("сканируем точный F202 сервис Natro")
        ...
        private func connect(
            ...
            diagnostic("найден кандидат F202; устанавливаем BLE-соединение")
        ...
        private func emitOperationalOnce(generation: BleRoleSwitchPolicy.Sequence) {
            ...
            managerStartupTimerToken = nil
            diagnostic("Central-маршрут локально работает")
...
extension HelperCentralRoute.Coordinator: CBCentralManagerDelegate {
    public func centralManagerDidUpdateState(_ central: CBCentralManager) {
        ...
        case .poweredOn:
            diagnostic("Bluetooth включён; проверяем восстановленный F202 owner")
            managerStartupTimerToken = nil
        ...
        case .poweredOff, .resetting:
            diagnostic(central.state == .resetting
                ? "Core Bluetooth перезапускается"
                : "Bluetooth выключен")
            switch lifecycle {
    ...
    public func centralManager(
        ...
        diagnostic(restored.isEmpty
            ? "восстановленного F202 owner нет"
            : "Core Bluetooth вернул восстановленный F202 owner")
    ...
    public func centralManager(_ central: CBCentralManager, didConnect candidate: CBPeripheral) {
        ...
        deadlineToken = nil
        diagnostic("BLE-соединение с F202 установлено; ищем сервис")
        lifecycle = .discoveringService(generation: generation)
        candidate.discoverServices([HelperCentralRoute.serviceUUID])
...
extension HelperCentralRoute.Coordinator: CBPeripheralDelegate {
    public func peripheral(_ peripheral: CBPeripheral, didDiscoverServices error: Error?) {
        ...
        diagnostic("F202 сервис подтверждён; проверяем характеристики")
    ...
    public func peripheral(
        ...
        diagnostic("контракт F202 характеристик подтверждён; читаем peer proof")
    ...
    public func peripheral(
        ...
        if characteristic === carRemoteCharacteristic {
            guard case .active(let activeGeneration) = lifecycle,
                  ...
                  AuthenticatedC5FrameV1.isValid(value) else { return }
            observer?.helperCentralRoute(
                self,
        ...
        if characteristic === peerProofCharacteristic {
            ...
            diagnostic("peer proof Natro принят; включаем CONTROL уведомления")
    ...
    public func peripheral(
        ...
        if characteristic === carRemoteCharacteristic {
            ...
            diagnostic("C5 подписка подтверждена; Route B полностью готов")
        ...
        deadlineToken = nil
        diagnostic("CONTROL подписка подтверждена; отправляем защищённый HELLO")
    ...
    public func peripheral(
        ...
        case .hello:
            ...
            diagnostic("HELLO принят Natro; включаем C5 уведомления")
