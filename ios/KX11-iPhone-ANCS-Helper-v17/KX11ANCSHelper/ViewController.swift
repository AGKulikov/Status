...
/// Helper v17 exposes two mutually exclusive BLE routes. Peripheral is the v11 production route
...
final class ViewController: UIViewController {
    ...
    private let restoreIdentifier =
        "ru.natro.kx11ancshelper.peripheral.v17.single-link-g2"
    private let centralRestoreIdentifier =
        "ru.natro.kx11ancshelper.central.v17.geely-ancs-g2"
    ...
    override func viewDidLoad() {
        ...
        append("v17: выбран iPhone \(role.title); Peripheral сохраняет маршрут v11")
    ...
    private func buildInterface() {
        ...
        titleLabel.text = "KX11 ANCS HELPER v17"
    ...
    private func retryCentralSecure(_ peripheral: CBPeripheral, error: Error) {
        ...
        // HA1169 deliberately returns one status-5 challenge on every new physical link. A second
