# KX11 ANCS Helper v17 for iPhone

Helper v17 accompanies Status Widget HA1169 and keeps the explicit iPhone BLE-role selector. The
...
a role or pairing change: install Helper v17 and HA1169 together. It prevents either Core Bluetooth
...
4. The first B3 read on a new physical link receives one ATT authentication challenge from HA1169;
...
Helper v17 first accepts a complete characteristic list already attached to the current
...
Helper v17 also treats a removed D2D9 service or invalid ATT handle as a broken BLE session. It
