#!/usr/bin/env python3
"""Portable v54 ECDH/SAS/wire vector and source-security contract."""
...
def verify_source_contract() -> None:
    ...
    assert 'title.text = "Настройки Natro"' in ui
...
if __name__ == "__main__":
    ...
    print("PASS: v54 preserves ECDH/SAS, dual-key WAL recovery, C4 gates and shared vectors")
