...
public final class HelperSwitchRuntimeCoordinator {
    ...
    public init(
        ...
        if quarantinedCorruption {
            ...
            self.bootDetail = "Helper 62: терминальный снимок v56 восстановлен в основной Route A"
            ...
            self.switchToken = nil
            self.pendingStartupEffects = []
            self.bootDetail = "Helper 62: legacy-настройка перенесена в основной Route A"
            defaults.removeObject(forKey: Self.legacyRoleKey)
            try Self.persist(
                policy: policy,
                origin: nil,
