#!/usr/bin/env python3
"""Portable source/asset audit for Helper 62 compact Live Activity and companion UI."""
...
assert 'replaceActivities(reason: "обновление Helper 62")' in manager
assert "minimumActivityUpdateInterval: TimeInterval = 3.0" in manager
...
print("PASS: Helper v62 compact payload, car asset, demo controls, journals and startup repair")
