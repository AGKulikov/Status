#!/usr/bin/env python3
"""Portable source/asset audit for Helper 61 compact Live Activity and companion UI."""
...
assert 'replaceActivities(reason: "обновление Helper 61")' in manager
...
print("PASS: Helper v61 compact payload, car asset, demo controls, journals and startup repair")
