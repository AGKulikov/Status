#!/usr/bin/env python3
"""Portable source/asset audit for Helper 57 compact Live Activity and companion UI."""
...
assert 'replaceActivities(reason: "обновление Helper 57")' in manager
...
print("PASS: Helper v57 compact payload, car asset, demo controls, journals and startup repair")
