    ...
    public final class Coordinator: NSObject {
        ...
        internal init(
            ...
            self.queue = DispatchQueue(
                label: "ru.natro.kx11ancshelper.v47.routeB.central",
                qos: .userInitiated
            )
        ...
        private func beginAcquisition(on manager: CBCentralManager) {
            ...
            armDeadline(seconds: 15, generation: generation, reason: "F202 scan timeout")
        }
...
extension HelperCentralRoute.Coordinator: CBPeripheralDelegate {
    ...
    public func peripheral(
        ...
        guard characteristic === controlCharacteristic, error == nil,
              ...
              frame.type != .peerProof,
              frame.mode == .androidCentral else {
    ...
    public func peripheral(
        ...
        guard peripheral === self.peripheral, characteristic === controlCharacteristic,
              let generation,
