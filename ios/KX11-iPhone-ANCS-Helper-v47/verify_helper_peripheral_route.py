...
def main() -> None:
    ...
    assert ".v47.installationUUID" not in route
    ...
    assert "requestNotSupported" not in route
    ...
    print(
        ...
        "generation-gated, exact-unsubscribe drained, migration-classified, top-level-owned, "
        "and strict frozen-owner C/A adapted"
    )
