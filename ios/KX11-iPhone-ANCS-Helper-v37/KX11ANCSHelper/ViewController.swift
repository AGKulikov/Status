...
/// Helper v37 keeps one long-lived RequiresANCS Central owner and performs one minimal security
...
/// watchdog is used. The iPhone-owned F05 relay carries telemetry and Android's post-CCCD proof.
final class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        append("v37: стабильный F04 owner + current-link security gate")
    ...
    private func buildInterface() {
        ...
        titleLabel.text = "KX11 ANCS HELPER v37"
