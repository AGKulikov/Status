...
/// Helper v33 keeps one long-lived Central owner and gates ANCS-READY on real iOS authorization.
...
final class ViewController: UIViewController {
    ...
    // These fixed F04 UUIDs remain for the legacy iPhone-peripheral route. In Central mode v33
    ...
    /// exact v33 owner. A system-wide connection discovered through another app is never adopted
    ...
    override func viewDidLoad() {
        ...
        append("v33: выбран iPhone \(role.title); Peripheral сохраняет маршрут v11")
    ...
    private func buildInterface() {
        ...
        titleLabel.text = "KX11 ANCS HELPER v33"
