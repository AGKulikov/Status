#!/usr/bin/env python3
"""Portable v52 ECDH/SAS/wire vector and source-security contract."""
...
def verify_source_contract() -> None:
    ...
    assert 'title.text = "KX11 ANCS v52"' in ui
...
if __name__ == "__main__":
    ...
    print("PASS: v52 preserves ECDH/SAS, dual-key WAL recovery, C4 gates and shared vectors")
