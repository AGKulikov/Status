...
/// Helper v39 keeps one long-lived RequiresANCS Central owner and performs one minimal security
...
/// F05 relay carries telemetry and Android's authoritative post-CCCD proof.
final class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        append("v39: B3-ready без privacy deadlock + bounded F04 ownership claims")
    ...
    private func buildInterface() {
        ...
        titleLabel.text = "KX11 ANCS HELPER v39"
