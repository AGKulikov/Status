# KX11 ANCS Helper v39 for iPhone

Helper v39 is the matched companion for Status Widget `v2.8.2-ha1201`. Select **Central** in
...
Run `sh ./verify-v39-contract.sh` before packaging.
