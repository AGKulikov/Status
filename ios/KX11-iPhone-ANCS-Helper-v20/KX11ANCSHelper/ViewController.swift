...
/// Helper v20 uses Central only to bootstrap the protected ANCS link. At the same time it exposes
...
final class ViewController: UIViewController {
    ...
    private let restoreIdentifier =
        "ru.natro.kx11ancshelper.peripheral.v20.single-link-g3"
    private let centralRestoreIdentifier =
        "ru.natro.kx11ancshelper.central.v20.geely-ancs-g2"
    ...
    override func viewDidLoad() {
        ...
        append("v20: выбран iPhone \(role.title); Peripheral сохраняет маршрут v11")
        ...
        append("Телеметрия: события iOS + B4 READ/NOTIFY на рабочем ANCS link")
    ...
    private func buildInterface() {
        ...
        titleLabel.text = "KX11 ANCS HELPER v20"
    ...
    private func connectCentral(_ peripheral: CBPeripheral, reason: String) {
        ...
        // deterministic: Helper v20 always resolves the next generation from a fresh advert.
...
extension ViewController: CBCentralManagerDelegate {
    ...
    private func handleCentralDisconnect(_ peripheral: CBPeripheral, isReconnecting: Bool,
        ...
        if isReconnecting {
            // Handles a restored connection originally created by an older Helper. New v20
