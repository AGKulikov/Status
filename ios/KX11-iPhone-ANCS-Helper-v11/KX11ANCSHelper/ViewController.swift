...
/// Helper v11 has exactly one BLE role: iPhone is the peripheral/GATT server and KX11 is the
...
final class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        append("v11: мгновенная телеметрия по единому маршруту KX11 central → iPhone peripheral")
    ...
    private func buildInterface() {
        ...
        titleLabel.text = "KX11 ANCS HELPER v11"
