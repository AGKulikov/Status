...
Helper v30 is the companion for Status Widget HA1192. Select **Central** both in Helper and in
...
HA1192 commits the B3 proof synchronously before returning success and does not bond from an
...
6. HA1192 maps the protected link to the verified bonded iPhone, subscribes to ANCS Notification
...
Install HA1192 and Helper v30 as a matched pair, open Helper once, select **Central**, and leave
