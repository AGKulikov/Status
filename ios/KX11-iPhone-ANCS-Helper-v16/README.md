# KX11 ANCS Helper v16 for iPhone

Helper v16 accompanies Status Widget HA1168 and keeps the explicit iPhone BLE-role selector. The
...
Helper v16 also treats a removed D2D9 service or invalid ATT handle as a broken BLE session. It
