...
/// Helper v16 exposes two mutually exclusive BLE routes. Peripheral is the v11 production route
...
final class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        append("v16: выбран iPhone \(role.title); Peripheral сохраняет маршрут v11")
    ...
    private func buildInterface() {
        ...
        titleLabel.text = "KX11 ANCS HELPER v16"
    ...
    private func retryCentralSecure(_ peripheral: CBPeripheral, error: Error) {
        ...
        // HA1167 deliberately returns one status-5 challenge on every new physical link. A second
    ...
    private func responseData(for characteristic: CBCharacteristic) -> Data? {
        ...
        case infoUUID:
            return Data("\(logicalName)/16/realtime-single-link".utf8)
        case secureUUID:
...
extension ViewController: CBPeripheralDelegate {
    ...
    func peripheral(_ peripheral: CBPeripheral,
        ...
        guard centralControlCharacteristic?.properties.contains(.write) == true,
              ...
              centralTelemetryCharacteristic?.properties.contains(.write) == true,
              centralTelemetryCharacteristic?.properties.contains(.notify) == true else {
            append("Geely_ANCS properties invalid: B2 WRITE, B3 READ, "
                + "B4 WRITE+NOTIFY required")
