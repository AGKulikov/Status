# KX11 ANCS Helper v66 Personal Team — Bluetooth vehicle control and local Live Activity
...
Minimum supported iOS: 14.0. Helper v66 uses the system CryptoKit HKDF implementation for the
enrollment protocol; devices left on iOS 13.x cannot install this build.

Helper v66 pairs with the Natro C4-enrollment runtime and keeps Route A as the production
topology:
...
Helper 66 embeds `NatroLiveActivityExtension` (minimum iOS 16.2) while the main Bluetooth app keeps
...
Helper 63 retains C5, `D2D9E4C5-47F1-4E44-A8BB-A932FD5AF200`, without changing the occupied C2 role
...
```sh
./verify-v66-personal-contract.sh
```
...
Before calling v66 Personal Team stable:
