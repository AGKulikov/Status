...
python3 "$ROOT/verify_live_activity_v66_personal.py"

PROJECT="$ROOT/KX11ANCSHelper.xcodeproj/project.pbxproj"
[ "$(grep -Fc 'CURRENT_PROJECT_VERSION = 66;' "$PROJECT")" -eq 4 ]
[ "$(grep -Fc 'MARKETING_VERSION = 66.0;' "$PROJECT")" -eq 4 ]
...
grep -Fq 'Build: 66' "$ROOT/RELEASE.txt"
...
echo 'PASS: Helper v66 Personal Team direct Live Activity controls'
