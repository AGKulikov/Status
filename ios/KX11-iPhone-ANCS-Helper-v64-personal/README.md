# KX11 ANCS Helper v64 Personal Team — Bluetooth vehicle control and local Live Activity
...
Minimum supported iOS: 14.0. Helper v64 uses the system CryptoKit HKDF implementation for the
enrollment protocol; devices left on iOS 13.x cannot install this build.

Helper v64 pairs with the Natro C4-enrollment runtime and keeps Route A as the production
topology:
...
```sh
./verify-v64-personal-contract.sh
```
...
Before calling v64 Personal Team stable:
