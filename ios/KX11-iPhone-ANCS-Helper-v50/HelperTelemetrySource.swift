...
public final class HelperTelemetrySource {
    ...
    private let pathQueue = DispatchQueue(label: "ru.natro.kx11ancshelper.v50.telemetry.path")
    ...
    private static func classify(
        ...
        // Helper v50 targets iOS 13+, so the pre-iOS-12 single-service API is neither needed nor
