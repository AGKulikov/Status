...
public enum IphoneBleWireProtocolV2 {
    ...
    public struct ControlFrame: Equatable {
        ...
        /// For C/A this is the desired target mode, not the route being stopped.
        public let mode: Mode
        public let flags: UInt8
        /// Stable installation UUID bytes for H; exact random switch token for C/A.
    ...
    private static func encodeControl(
        ...
        if type == .peerProof {
            ...
            precondition(flags == 0, "C/A flags must be zero")
        }
