#!/usr/bin/env python3
"""Portable audit for Helper 67 Personal Team local ActivityKit lifecycle and controls."""
...
assert 'replaceActivities(reason: "обновление Helper 67")' in manager
...
print("PASS: Helper v67 Personal Team entitlement-clean Live Activity controls and compact payload")
