# KX11 ANCS Helper v67 Personal Team — Bluetooth vehicle control and local Live Activity
...
Minimum supported iOS: 14.0. Helper v67 uses the system CryptoKit HKDF implementation for the
enrollment protocol; devices left on iOS 13.x cannot install this build.

Helper v67 pairs with the Natro C4-enrollment runtime and keeps Route A as the production
topology:
...
Helper 67 embeds `NatroLiveActivityExtension` (minimum iOS 16.2) while the main Bluetooth app keeps
...
```sh
./verify-v67-personal-contract.sh
```
...
Before calling v67 Personal Team stable:
