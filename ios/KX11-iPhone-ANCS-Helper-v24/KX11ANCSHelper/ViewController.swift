...
/// Helper v24 uses Central only to bootstrap the protected ANCS link. At the same time it exposes
...
final class ViewController: UIViewController {
    ...
    // Generation 3 is iPhone-owned and exists only on the post-handoff Android->iPhone link.
    // Keeping it separate from Android's generation-2 bootstrap database prevents either side
    // from reusing the opposite GATT role's cached B4 handle.
    private let telemetryRelayServiceUUID =
        CBUUID(string: "D2D9E4B0-47F1-4E44-A8BB-A932FD5A2F03")
    private let telemetryRelayUUID =
        CBUUID(string: "D2D9E4B4-47F1-4E44-A8BB-A932FD5A2F03")
    ...
    private let restoreIdentifier =
        "ru.natro.kx11ancshelper.peripheral.v24.single-link-g3"
    private let centralRestoreIdentifier =
        "ru.natro.kx11ancshelper.central.v24.geely-ancs-g2"
    ...
    override func viewDidLoad() {
        ...
        append("v24: выбран iPhone \(role.title); Peripheral сохраняет маршрут v11")
    ...
    private func buildInterface() {
        ...
        titleLabel.text = "KX11 ANCS HELPER v24"
    ...
    private func publishServiceIfPossible() {
        ...
        append(relay
            ? "Публикую B4 telemetry relay generation 3 без отдельной рекламы"
    ...
    private func connectCentral(_ peripheral: CBPeripheral, reason: String) {
        ...
        // deterministic: Helper v24 always resolves the next generation from a fresh advert.
...
extension ViewController: CBCentralManagerDelegate {
    ...
    private func handleCentralDisconnect(_ peripheral: CBPeripheral, isReconnecting: Bool,
        ...
        if isReconnecting {
            // Handles a restored connection originally created by an older Helper. New v24
