...
/// Helper v19 uses Central only to bootstrap the protected ANCS link. At the same time it exposes
...
final class ViewController: UIViewController {
    ...
    private let restoreIdentifier =
        "ru.natro.kx11ancshelper.peripheral.v19.single-link-g3"
    private let centralRestoreIdentifier =
        "ru.natro.kx11ancshelper.central.v19.geely-ancs-g2"
    ...
    override func viewDidLoad() {
        ...
        append("v19: выбран iPhone \(role.title); Peripheral сохраняет маршрут v11")
    ...
    private func buildInterface() {
        ...
        titleLabel.text = "KX11 ANCS HELPER v19"
    ...
    private func connectCentral(_ peripheral: CBPeripheral, reason: String) {
        ...
        // deterministic: Helper v19 always resolves the next generation from a fresh advert.
    ...
    private func responseData(for characteristic: CBCharacteristic) -> Data? {
        ...
        case infoUUID:
            return Data("\(logicalName)/19/realtime-single-link".utf8)
        case secureUUID:
...
extension ViewController: CBCentralManagerDelegate {
    ...
    private func handleCentralDisconnect(_ peripheral: CBPeripheral, isReconnecting: Bool,
        ...
        if isReconnecting {
            // Handles a restored connection originally created by an older Helper. New v19
