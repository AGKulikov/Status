...
public final class HelperTelemetrySource {
    ...
    private let pathQueue = DispatchQueue(label: "ru.natro.kx11ancshelper.v53.telemetry.path")
    ...
    private static func classify(
        ...
        // Helper v53 targets iOS 14+, so the pre-iOS-12 single-service API is neither needed nor
