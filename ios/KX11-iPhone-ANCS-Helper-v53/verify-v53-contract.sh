...
[ "$(grep -Fc 'CURRENT_PROJECT_VERSION = 53;' "$PROJECT")" -eq 2 ]
[ "$(grep -Fc 'MARKETING_VERSION = 53.0;' "$PROJECT")" -eq 2 ]
...
echo 'PASS: Helper v53 preserves enrollment/ANCS and adds exact-owner Bluetooth car control'
