# KX11 ANCS Helper v26 for iPhone

Helper v26 accompanies Status Widget HA1187. Select **Central** both in Helper and in
...
does not attach its ANCS client until B2/B3 succeeds. Helper v26 removes that cycle.
...
4. Helper writes `ANCS-HANDOFF` to encrypted B3. HA1187 preserves the verified bonded identity
...
6. HA1187 matches the bonded incoming callback, registers its ANCS GATT client immediately and
   discovers/subscribes to ANCS plus the iPhone-owned F05/B4 relay.
7. A B4 read/subscription is the final proof that the Android ANCS owner is operational.
...
with the same Apple Development Team as the existing Helper. Install HA1187 and Helper v26 as a
