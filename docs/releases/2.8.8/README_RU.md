...
GATE-082 не пройден. Факт установки Navigator именно из этого комплекта ещё не
уточнён; несовместимость пары — проверяемая гипотеза, не установленная причина.
