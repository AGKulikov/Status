...
/** Visual, code-free editor for the functional elements placed in HOME blocks. */
public final class PanelElementSettingsActivity extends AppCompatActivity {
    ...
    private View buildContent() {
        ...
        hint.setText("Здесь собраны блоки с общим редактором состава. Медиа, навигация, "
                ...
                + "визуальный экран в разделе «Блоки» единого центра настроек.");
        hint.setTextSize(13);
        hint.setAlpha(.68f);
    ...
    private void renderEditor() {
        ...
        if (enabled.isEmpty()) {
            addHint(editor, LauncherLayoutStore.NAVIGATION.equals(panel.id)
                    ...
                    : "Блок сейчас пустой и на HOME будет скрыт полностью.");
        }
