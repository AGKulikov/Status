...
public class DialerCodeReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        // An inactive service mode must never intercept normal outgoing calls.
        if (!new AppsToHideStorage(context).hasHiddenApps() || !new PinStorage(context).hasPin()) return;
