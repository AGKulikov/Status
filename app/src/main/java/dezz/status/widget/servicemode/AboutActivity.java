...
import dezz.status.widget.databinding.ServiceModeActivityAboutBinding;
...
public class AboutActivity extends AppCompatActivity {
    private ServiceModeActivityAboutBinding binding;

    @SuppressLint("SetJavaScriptEnabled")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ServiceModeActivityAboutBinding.inflate(getLayoutInflater());
        ...
        binding.aboutFallback.setText(Html.fromHtml(
                getString(R.string.service_mode_about_fallback), Html.FROM_HTML_MODE_COMPACT));
        ...
        if (isOnline()) {
            web.loadUrl(getString(R.string.service_mode_about_url));
        } else {
            showFallback();
        }
    }
