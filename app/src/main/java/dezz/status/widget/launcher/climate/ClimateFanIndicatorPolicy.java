 ...
 * function for the confirmed climate mode. Manual speed keeps all nine vehicle positions,
 * while AUTO arrives as one of the vehicle's five named intensity profiles. Consumers must not
