...
public final class LauncherIconResolver {
    ...
    private static final List<Preset> PRESETS = Arrays.asList(
            ...
            new Preset("hood_open", "Открыть капот"),
            new Preset("car_doors", "Двери автомобиля"),
            new Preset("car_window", "Стеклоподъёмники"),
            new Preset("sunroof", "Люк / панорама"),
            new Preset("mirror_fold", "Сложить зеркала"),
