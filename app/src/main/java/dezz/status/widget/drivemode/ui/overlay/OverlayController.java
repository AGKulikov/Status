...
import dezz.status.widget.drivemode.util.Logs;
...
public class OverlayController {
    ...
    private void handlePillClick(int modeCode, int position) {
        // Highlight only after Natro receives confirmed vehicle read-back.
    ...
    private void ensureAttached() {
        ...
        root = LayoutInflater.from(context).inflate(R.layout.drive_selector_overlay_root, null);
    ...
    private void ensureWidthMetricsCached() {
        ...
        int minWidthPx = (int) context.getResources().getDimension(R.dimen.drive_selector_overlay_pill_min_width);
        int spacingPx = (int) context.getResources().getDimension(R.dimen.drive_selector_overlay_item_spacing);
        cachedPillFootprintPx = minWidthPx + spacingPx * 2;
        cachedSidePaddingPx = (int) context.getResources().getDimension(R.dimen.drive_selector_overlay_padding_horizontal);
    }
    ...
    private void broadcastVisibility(boolean isShowing) {
        ...
        dezz.status.widget.drivemode.service.DriveModeOverlayService.onVisibilityChanged(isShowing);
        try {
