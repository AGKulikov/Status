...
import dezz.status.widget.databinding.DriveSelectorActivityAboutBinding;
...
public class AboutActivity extends AppCompatActivity {
    ...
    private DriveSelectorActivityAboutBinding binding;

    @SuppressLint("SetJavaScriptEnabled")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = DriveSelectorActivityAboutBinding.inflate(getLayoutInflater());
        ...
        binding.aboutFallback.setText(Html.fromHtml(
                getString(R.string.drive_selector_about_fallback), Html.FROM_HTML_MODE_COMPACT));
        ...
        if (isOnline()) {
            web.loadUrl(getString(R.string.drive_selector_about_url));
        } else {
            showFallback();
        }
    }
