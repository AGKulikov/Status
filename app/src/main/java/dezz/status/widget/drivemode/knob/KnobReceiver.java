...
public class KnobReceiver extends BroadcastReceiver {
    ...
    public static final String EXTRA_DIRECTION = "dezz.status.widget.drivemode.extra.DIRECTION";
    public static final String EXTRA_STEPS = "dezz.status.widget.drivemode.extra.STEPS";
    ...
    private static final Set<String> TRUSTED_SENDERS = new HashSet<>(Arrays.asList(
            ...
            "dezz.status.widget.drivemode"  // ourselves (for tests)
    ));
