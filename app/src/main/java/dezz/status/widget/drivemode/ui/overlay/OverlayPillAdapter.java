...
package dezz.status.widget.drivemode.ui.overlay;
...
public class OverlayPillAdapter extends RecyclerView.Adapter<OverlayPillAdapter.PillVh> {
    ...
    public PillVh onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.drive_selector_overlay_mode_pill, parent, false);
    ...
    public void onBindViewHolder(@NonNull PillVh h, int position) {
        ...
        int onSurface = ContextCompat.getColor(ctx, R.color.drive_selector_m3_on_surface);
        int onSurfaceVariant = ContextCompat.getColor(ctx, R.color.drive_selector_m3_on_surface_variant);
        ...
        if (active) {
            h.iconHolder.setBackgroundResource(R.drawable.drive_selector_bg_pill_active);
            h.label.setTextColor(onSurface);
            h.label.setAlpha(1f);
        } else {
            h.iconHolder.setBackgroundResource(R.drawable.drive_selector_bg_pill_inactive);
    ...
    static class PillVh extends RecyclerView.ViewHolder {
        ...
        PillVh(View v) {
            ...
            holderActivePx = r.getDimensionPixelSize(R.dimen.drive_selector_overlay_pill_icon);
            holderInactivePx = r.getDimensionPixelSize(R.dimen.drive_selector_overlay_pill_icon_small);
            iconActivePx = r.getDimensionPixelSize(R.dimen.drive_selector_overlay_pill_icon_image);
            iconInactivePx = r.getDimensionPixelSize(R.dimen.drive_selector_overlay_pill_icon_image_small);
            labelActivePx = r.getDimension(R.dimen.drive_selector_overlay_pill_label);
            labelInactivePx = r.getDimension(R.dimen.drive_selector_overlay_pill_label_small);
        }
