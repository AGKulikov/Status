...
public final class DimMenuConflictPolicy {
    public enum Reason {
        NONE, DISABLED, DISPLAY_OFF, ENGINE_OFF, MNAVI, INSTRUMENT_PANEL,
        CONTROL_CENTER, OTHER_DIM_TAB
    }
    ...
    public static Reason reason(boolean enabled, boolean displayInteractive,
                                boolean engineOn, boolean mnavActive,
                                boolean instrumentPanelActive, int dimTab,
        ...
        if (instrumentPanelActive) return Reason.INSTRUMENT_PANEL;
